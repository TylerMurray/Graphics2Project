...
void App::SetWindow(CoreWindow^ window)
{
	...
	window->PointerExited +=
		ref new Windows::Foundation::TypedEventHandler<Windows::UI::Core::CoreWindow ^, Windows::UI::Core::PointerEventArgs ^>(this, &App7::App::OnPointerExited);
...
void App::Load(Platform::String^ entryPoint)
{
	if (m_main == nullptr)
	{
		m_main = std::unique_ptr<App7Main>(new App7Main(m_deviceResources));
	}
}
...
void App7::App::OnPointerExited(Windows::UI::Core::CoreWindow ^sender, Windows::UI::Core::PointerEventArgs ^args)
{
	diffx = 0;
	diffy = 0;
	left_click = false;
...
void App7::App::OnKeyDown(Windows::UI::Core::CoreWindow ^ sender, Windows::UI::Core::KeyEventArgs ^ args)
{
